...
PHOTOS = {
    ...
    "top_crypto": "Group 1 (23).png",  # "Топ-10 криптовалют"

    # Новости
    "news_menu": "Group 1 (12).png",  # "Выберите категорию новостей"
    "crypto_news": "Group 1 (14).png",  # "Криптовалютные новости"
    "financial_news": "Group 1 (13).png",  # "Финансовые новости"
    "latest_news": "Group 1 (20).png",  # "Последние Финансовые новости"
    "economy_news": "Group 1 (15).png",  # "Экономические новости"
    "banking_news": "Group 1 (16).png",  # "Новости банковского сектора"
    "russia_news": "Group 1 (17).png",  # "РФ Все новости"
    "news_search": "Group 1 (19).png",  # "Поиск новостей"

    # Помощь
    "help": "Group 1 (21).png",  # "Помощь по использованию бота"
}
